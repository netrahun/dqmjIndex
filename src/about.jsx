  ...
  return (
    showAbout && (
      <div id="aboutWrapper">
        ...
        >
          <img src="/dqmjIndex/src/assets/info.svg" />
        </button>
        <section id="aboutSection">
          ...
          <img src="/dqmjIndex/src/assets/mockup.png" className="aboutAsset" />
          ...
          <img
            src="/dqmjIndex/src/assets/mockup_2.png"
          ...
          <section id="explain-pokedex" className="flexcol">
            <img
              src="/dqmjIndex/src/assets/pokedexMobile1.png"
            ...
            <img
              src="/dqmjIndex/src/assets/pokedexMobile2.png"
              className="pokeMobileView"
            ></img>
            <p>
            ...
            <img
              src="/dqmjIndex/src/assets/pokedexMobile3.png"
              className="pokeMobileView"
            ></img>
            <p>
            ...
            <img
              src="/dqmjIndex/src/assets/pokedexMobile4.png"
              className="pokeMobileView"
            ></img>
            <p>
            ...
            <img
              src="/dqmjIndex/src/assets/pokedexMobile5.png"
              className="pokeMobileView"
            ></img>
            <p>
            ...
            <img
              src="/dqmjIndex/src/assets/pokedex_example.png"
              id="pokedex-scr"
            />
          </section>
