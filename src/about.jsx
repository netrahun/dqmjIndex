    ...
    showAbout && (
      <div id="aboutWrapper">
        ...
        <section id="aboutSection">
          ...
          <img src="./src/assets/mockup.png" className="aboutAsset" />
          ...
          <section id="explain-pokedex" className="flexcol">
            <img
              src="./src/assets/pokedexMobile1.png"
            ...
            <img
              src="./src/assets/pokedexMobile2.png"
              className="pokeMobileView"
            ></img>
            <p>
            ...
            <img
              src="./src/assets/pokedexMobile3.png"
              className="pokeMobileView"
            ></img>
            <p>
            ...
            <img
              src="./src/assets/pokedexMobile4.png"
              className="pokeMobileView"
            ></img>
            <p>
            ...
            <img
              src="./src/assets/pokedexMobile5.png"
              className="pokeMobileView"
            ></img>
            <p>
            ...
            <img
              src="./src/assets/pokedex_example.png"
              id="pokedex-scr"
            />
          </section>
